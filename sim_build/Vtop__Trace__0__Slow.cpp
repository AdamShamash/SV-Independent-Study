...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedFst* tracep) {
    ...
    tracep->declBit(c+11,0,"reading",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+12,0,"switchTest",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+13,0,"f_drive_c",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->pushPrefix("I2C_main", VerilatedTracePrefixType::SCOPE_MODULE);
    tracep->declBit(c+14,0,"sda_i",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+15,0,"sda_o",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBit(c+24,0,"reading",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+25,0,"switchTest",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+26,0,"f_drive_c",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+27,0,"scl_1x",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+28,0,"rw",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+29,0,"writeComplete",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+30,0,"repeated_start",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+31,0,"sendStart",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+32,0,"sendStop",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+33,0,"tester",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+34,0,"ackCount",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBus(c+35,0,"counter",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 1,0);
    tracep->declBus(c+36,0,"address_check",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 2,0);
    tracep->declBus(c+37,0,"bit_count",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
...
VL_ATTR_COLD void Vtop___024root__trace_full_0_sub_0(Vtop___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+11,(vlSelfRef.reading));
    bufp->fullBit(oldp+12,(vlSelfRef.switchTest));
    bufp->fullBit(oldp+13,(vlSelfRef.f_drive_c));
    bufp->fullBit(oldp+14,(vlSelfRef.I2C_main__DOT__sda_i));
    bufp->fullBit(oldp+15,(vlSelfRef.I2C_main__DOT__sda_o));
    ...
    bufp->fullBit(oldp+24,(vlSelfRef.I2C_main__DOT__reading));
    bufp->fullBit(oldp+25,(vlSelfRef.I2C_main__DOT__switchTest));
    bufp->fullBit(oldp+26,(vlSelfRef.I2C_main__DOT__f_drive_c));
    bufp->fullBit(oldp+27,(vlSelfRef.I2C_main__DOT__scl_1x));
    bufp->fullBit(oldp+28,(vlSelfRef.I2C_main__DOT__rw));
    bufp->fullBit(oldp+29,(vlSelfRef.I2C_main__DOT__writeComplete));
    bufp->fullBit(oldp+30,(vlSelfRef.I2C_main__DOT__repeated_start));
    bufp->fullBit(oldp+31,(vlSelfRef.I2C_main__DOT__sendStart));
    bufp->fullBit(oldp+32,(vlSelfRef.I2C_main__DOT__sendStop));
    bufp->fullBit(oldp+33,(vlSelfRef.I2C_main__DOT__tester));
    bufp->fullBit(oldp+34,(vlSelfRef.I2C_main__DOT__ackCount));
    bufp->fullCData(oldp+35,(vlSelfRef.I2C_main__DOT__counter),2);
    bufp->fullCData(oldp+36,(vlSelfRef.I2C_main__DOT__address_check),3);
    bufp->fullCData(oldp+37,(vlSelfRef.I2C_main__DOT__bit_count),4);
